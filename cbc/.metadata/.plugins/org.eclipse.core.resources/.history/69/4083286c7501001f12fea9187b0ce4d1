...
public class SimulatedCamera extends Camera {
	...
	public float track_angle(int ch, int i) {
		return 0.f;
	}
	
	// Gets the length in pixels of the major and minor axes of the bounding ellipse
	public int track_major_axis(int ch, int i) {
		return 0;
	}
	
	public int track_minor_axis(int ch, int i) {
		return 0;
	}

	// Return the timestamp (in milliseconds) of the current frame
	public int track_capture_time() {
		return 0;
	}
	...
	public int track_previous_capture_time() {
		return 0;
	}
